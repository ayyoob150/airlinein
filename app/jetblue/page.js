...
export default function Page() {
  return (
    <div  className="flex gap-0 justify-center flex-wrap md:flex-nowrap flex-col-reverse sm:flex-row">
      ...
      <section className=" space-y-4">
        <div className="flex justify-between gap-6 items-center">
              ...
              <Image
                src="https://media.licdn.com/dms/image/v2/D4E0BAQE8Ao2ZA_QjNQ/company-logo_200_200/company-logo_200_200/0/1719235850843/jetblue_logo?e=2147483647&v=beta&t=1hr9nIhdhZMLZnPV_G7nR_dZBAuU9wFH7XWPPivgMvw"
                alt="jetblue history"
                width={250}
                height={90}
      ...
      {/* History Section */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">📜 Our Story: History & Evolution</h2>
      ...
      {/* Route Network */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">🌍 Route Network: Domestic Strength, Global Reach</h2>
        <p className="text-lg mb-2 font-medium">🏙️ Key U.S. Focus Cities:</p>
        ...
        <p className="text-lg mt-4 font-medium">🌐 International Expansion:</p>
        <ul className="list-disc pl-6 text-lg">
      ...
      {/* Experience */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">💺 JetBlue Experience</h2>
        <div className="space-y-4 text-lg">
          <div>
            <h3 className="text-2xl font-medium">👤 Core Economy</h3>
          ...
          <div>
            <h3 className="text-2xl font-medium">✨ Mint Premium Class</h3>
            <ul className="list-disc pl-6">
      ...
      {/* Leadership */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">🧑✈️ Leadership & Ownership</h2>
      ...
      {/* Strategy */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">📈 Strategy: High-Value, Low-Fare Model</h2>
        <ul className="list-disc pl-6 text-lg space-y-1">
      ...
      {/* Partnerships */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">🤝 Airline Partnerships & Alliances</h2>
      ...
      {/* News */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-blue-800">🚨 Recent News & Updates (2024–2025)</h2>
        <ul className="list-disc pl-6 text-lg space-y-1">
      ...
      {/* Environment */}
      <section>
        <h2 className="text-2xl font-medium mb-4 text-green-700">🌱 Environmental Responsibility</h2>
        <ul className="list-disc pl-6 text-lg">
      ...
      {/* Recognition */}
      <section className="bg-slate-100 p-6 rounded-xl shadow-lg">
        <h2 className="text-2xl font-medium mb-4 text-purple-700">⭐ Awards & Recognition</h2>
        <ul className="list-disc pl-6 text-lg">
      ...
      {/** Booking & Check-in */}
      <div>
        <h2 className="text-2xl font-medium">✈️ Booking & Check-In: Seamless & Stress-Free</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Baggage Policies */}
      <div>
        <h2 className="text-2xl font-medium">🧳 Baggage Policies: Fair & Predictable</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Entertainment */}
      <div>
        <h2 className="text-2xl font-medium">📡 Entertainment & Wi-Fi: Best in Class</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Food & Drink */}
      <div>
        <h2 className="text-2xl font-medium">🍴 Food & Beverage: Simple, Satisfying</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Crew */}
      <div>
        <h2 className="text-2xl font-medium">👨✈️ Cabin Crew: Caring & Genuine</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Network & Reliability */}
      <div>
        <h2 className="text-2xl font-medium">🌐 Flight Network & Reliability</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Sustainability */}
      <div>
        <h2 className="text-2xl font-medium">🌱 Sustainability Leadership</h2>
        <p className="text-lg leading-relaxed">
      ...
      {/** Passenger Quotes */}
      <div>
        <h2 className="text-2xl font-medium">💬 What Passengers Are Saying</h2>
        <blockquote className="border-l-4 border-sky-500 pl-4 italic text-lg text-slate-700">
      ...
      {/** Final Verdict */}
      <div>
        <h2 className="text-2xl font-medium">🛬 Final Verdict: A Hybrid Airline That Works</h2>
        <p className="text-lg leading-relaxed">
    ...
    <div>
        <ContactSection name="JetBlue" isSide={true}/>
